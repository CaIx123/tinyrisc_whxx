...
module pipe_ctrl_xyh(
    ...
    output wire[`XYH_STALL_WIDTH-1:0] stall_o,   // 流水线暂停(PC/IF/ID/EX各级)
    ...
    always @ (*) begin
        ...
        //     stall[`XYH_STALL_IF] = 1'b1;
        //     stall[`XYH_STALL_PC] = 1'b1;
        // end else if (stall_from_id_i) begin
        //     // stall[`XYH_STALL_EX] = 1'b0;
        //     stall[`XYH_STALL_ID] = 1'b0;
        //     stall[`XYH_STALL_IF] = 1'b0;
        //     stall[`XYH_STALL_PC] = 1'b1;
        // end else if (stall_from_if_i) begin
        //     // stall[`XYH_STALL_EX] = 1'b1;
        //     stall[`XYH_STALL_ID] = 1'b1;
        //     stall[`XYH_STALL_IF] = 1'b0;
        //     stall[`XYH_STALL_PC] = 1'b0;
        // end else begin
        //     // stall[`XYH_STALL_EX] = 1'b0;
        //     stall[`XYH_STALL_ID] = 1'b0;
        //     stall[`XYH_STALL_IF] = 1'b0;
