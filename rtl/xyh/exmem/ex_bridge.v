...
module ex_bridge(
    ...
    assign addr_rom_o = (tr_state == TR_ADDR) ? tx_data_i[`ROM_AWIDTH-1:0] :
                        data_reg[`ROM_AWIDTH-1:0];
    assign addr_ram_o = (tr_state == TR_ADDR) ? tx_data_i[`RAM_AWIDTH-1:0] :
