...
module tinyriscv_core(
    ...
    output wire[31:0] x26_o,                 // 寄存器x26值(用于测试成功信号)
    output wire[31:0] x27_o                  // 寄存器x27值(用于测试成功信号)
    ...
    wire[31:0] regs_x26_o;
    wire[31:0] regs_x27_o;
    ...
    assign x26_o = regs_x26_o;
    assign x27_o = regs_x27_o;
