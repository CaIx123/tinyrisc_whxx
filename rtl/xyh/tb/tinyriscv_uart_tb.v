...
module tinyriscv_uart_tb;
    ...
    localparam integer SIM_TIMEOUT_NS = 5000000;
    ...
    initial begin
        $dumpfile("tinyriscv_uart_tb.vcd");
        $dumpvars(0, tinyriscv_uart_tb);
    end
    ...
    initial begin
        $readmemh("inst.data", tinyriscv_uart_tb_0.u_exmem_top.u_exrom._ram);
    end

    tinyriscv_sys_top tinyriscv_uart_tb_0(
        .clk(clk),
        .rst(rst_n),
