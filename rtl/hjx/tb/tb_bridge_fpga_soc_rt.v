...
module tb_bridge_fpga_soc_rt;
    ...
    wire[31:0] x10 = u_fpga_soc.u_soc_top.u_tinyriscv_core.u_gpr_reg.regs[10];
    ...
    initial begin
        ...
        // jal  x0, 0
        u_fpga_soc.u_fpga_top.u_exrom._ram[0] = 32'h300007b7;
        u_fpga_soc.u_fpga_top.u_exrom._ram[1] = 32'h00100713;
        u_fpga_soc.u_fpga_top.u_exrom._ram[2] = 32'h00e7a023;
        u_fpga_soc.u_fpga_top.u_exrom._ram[3] = 32'h0000152f;
        u_fpga_soc.u_fpga_top.u_exrom._ram[4] = 32'h300007b7;
        u_fpga_soc.u_fpga_top.u_exrom._ram[5] = 32'h00c78793;
        u_fpga_soc.u_fpga_top.u_exrom._ram[6] = 32'h00a7a023;
        u_fpga_soc.u_fpga_top.u_exrom._ram[7] = 32'h0000006f;

        #100;
        rst_n = 1'b1;

        wait (u_fpga_soc.u_soc_top.u_tinyriscv_core.u_exu.u_exu_ext_rt.state == 4'd1);
    ...
    initial begin
        ...
        $display("BRIDGE_SOC_RT_TIMEOUT got=%h x10=%h scl=%b sda=%b rt_state=%0d iic_state=%0d addr_phase=%b data_phase=%b",
                 ...
                 u_fpga_soc.u_soc_top.u_tinyriscv_core.u_exu.u_exu_ext_rt.state,
                 u_fpga_soc.u_soc_top.u_iic.state, phase_iic_addr_pass, phase_iic_data_pass);
        $finish;
    end
