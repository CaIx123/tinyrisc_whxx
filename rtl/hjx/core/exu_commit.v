...
module exu_commit(
    ...
    wire use_alu_res = (~req_mem_i) &
                       (~req_bjp_i) &
                       (~req_ext_wb_i);
    wire alu_reg_we = use_alu_res & rd_we_i;

    assign reg_we_o = mem_reg_we_i | bjp_reg_we_i | ext_reg_we_i | alu_reg_we;
    ...
    always @ (*) begin
        ...
        case (1'b1)
            ...
            alu_reg_we:      reg_waddr = rd_waddr_i;
        endcase
    end
    ...
    always @ (*) begin
        ...
        case (1'b1)
            ...
            alu_reg_we:      reg_wdata = alu_reg_wdata_i;
        endcase
    end
