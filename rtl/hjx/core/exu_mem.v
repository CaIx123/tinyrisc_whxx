...
module exu_mem(
    ...
    assign mem_sel_o[0] = mem_addr_index00 | mem_op_sw_i | mem_op_lw_i;
    assign mem_sel_o[1] = mem_addr_index01 | ((mem_op_sh_i | mem_op_lh_i | mem_op_lhu_i) & mem_addr_index00) | mem_op_sw_i | mem_op_lw_i;
    assign mem_sel_o[2] = mem_addr_index10 | mem_op_sw_i | mem_op_lw_i;
    assign mem_sel_o[3] = mem_addr_index11 | ((mem_op_sh_i | mem_op_lh_i | mem_op_lhu_i) & mem_addr_index10) | mem_op_sw_i | mem_op_lw_i;
    ...
    // 写寄存器使能，收到ack当拍数据有效
    assign mem_reg_we_o = (mem_op_lb_i | mem_op_lh_i | mem_op_lw_i | mem_op_lbu_i | mem_op_lhu_i) & mem_rsp_hsked;

    // 写内存使能
    assign mem_mem_we_o = (mem_op_sb_i | mem_op_sh_i | mem_op_sw_i);
