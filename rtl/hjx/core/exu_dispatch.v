...
module exu_dispatch(
    ...
    wire[`DECINFO_WIDTH-1:0] ext_info = {`DECINFO_WIDTH{op_ext}} & dec_info_bus_i;
    assign ext_op_sid_o = ext_info[`DECINFO_EXT_SID];
    assign ext_op_rt_o = ext_info[`DECINFO_EXT_RT];
    assign ext_op_if_o = ext_info[`DECINFO_EXT_IF];
